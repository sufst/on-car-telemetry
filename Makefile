...
#			Imported from VCU project and further modified by Piotr Mikulowski (@rureverek, pm4u19@soton.ac.uk)
#               :
#   Description :   On-Car Telemetry makefile
#               :
###############################################################################
